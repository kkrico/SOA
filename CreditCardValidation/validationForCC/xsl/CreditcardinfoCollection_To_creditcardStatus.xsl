...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.9.0(build 180326.0917) AT [SUN MAY 27 23:10:57 BRT 2018]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns0="http://oracle.com/sca/soapservice/CreditCardValidation/validationForCC/WebService"
                ...
                exclude-result-prefixes="xsi xsl top tns plt xsd wsdl ns0 inp2 bpws xp20 mhdr bpel oraext dvm hwf med ids bpm xdk xref ora socket ldap">
  <xsl:template match="/">
    <inp2:creditcardStatus>
